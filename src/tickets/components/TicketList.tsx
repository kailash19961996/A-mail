            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-0.5">
                  <div className="text-gray-900 text-sm font-medium">{fullName(t)}</div>
                  <div className="text-[11px] text-gray-500">{dt}</div>
                </div>
                <div className="text-[13px] text-gray-700 font-medium mb-0.5">{t.subject}</div>
                <div className="text-[11px] text-gray-500 line-clamp-1">{lastMessage?.text || 'No messages yet'}</div>
              </button>
            )
          })}
      </div>
