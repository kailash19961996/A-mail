...
const TemplatesConfigPageView: React.FC = () => {
  return (
    <div className="p-6 animate-page-transition">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Templates Config</h1>
        <p className="text-gray-600">Configure communication templates</p>
      </div>
...
export default TemplatesConfigPageView;
